		...
		<div class="row-fluid">
			<div class="span2">
				<ul class="nav nav-list nav-stacked">
					...
					<li><?php echo HTML::Link('admin/carwashes/view', 'View') ?></li>
					<li><?php echo HTML::Link('admin/carwashes/add', 'Add'); ?></li>
					<li class="nav-header">Associations</li>
					<li><?php echo HTML::Link('admin/associations/view', 'View') ?></li>
					<li><?php echo HTML::Link('admin/associations/add', 'Add') ?></li>
					<li class="nav-header">Products</li>
					<li><?php echo HTML::Link('admin/products/view', 'View') ?></li>
