...
echo '</div>';
echo '<div>';
echo Form::checkbox('fundraiser', TRUE, $options['Fundraiser'], array('class' => 'checkbox'));
...
echo '</div>';
echo '<div>';
echo Form::checkbox('militarydiscount', TRUE, $options['MilitaryDiscount'], array('class' => 'checkbox'));
