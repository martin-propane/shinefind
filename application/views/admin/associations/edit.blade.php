...
?>
<?php
echo Form::open('admin/associations/edit/' . $id, 'POST', array('id' => 'addForm', 'class' => 'form-horizontal'));
...
echo '<div class = "controls">';
echo Form::text('fax', $fax, array('id' => 'fax', 'placeholder' => '123-456-7890'));
...
echo '<div class = "controls">';
echo Form::text('fee', $fee, array('placeholder' => '$1.00'));
echo '</div></div>';
