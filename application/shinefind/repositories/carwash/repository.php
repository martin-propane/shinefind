...
class Carwash_Repository {
	...
	public $DB_ATTRIBUTES = array('id', 'name', 'business_address', 'city', 'state', 'zip', 'phone', 'notes', 'email', 'website', 'corp_address', 'option_other', 'certified', 'sponsored', 'description', 'caption');
